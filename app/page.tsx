    ...
    <div className="flex flex-col gap-4 p-4 md:px-8 md:py-8 lg:px-16 lg:py-16">
      <div className="flex flex-col gap-4 max-w-2xl text-left mx-auto">
        <div className="flex flex-col gap-2">
          ...
          <h2 className="flex flex-row gap-2 items-center text-xl"><BookOpenText className="inline-block" />Phổ cập kiến thức về hệ sinh thái Ethereum</h2>
          <h2 className="flex flex-row gap-2 items-center text-xl"><Blocks className="inline-block" />Hỗ trợ builder, sinh viên, các nhà đầu tư Ethereum</h2>
          <h2 className="flex flex-row gap-2 items-center text-xl"><Building2 className="inline-block" />Thúc đẩy doanh nghiệp ứng dụng công nghệ Ethereum và Layer 2</h2>
          <p className="text-lg">ETH34 sẽ thực hiện các mục tiêu trên thông qua phương pháp xây dựng nội dung trên các mạng xã hội, đặc biệt là video. Đối với tớ, đây là định dạng media phù hợp nhất để kể lại những câu chuyện của cộng Ethereum tại Việt Nam tới cho bạn bè quốc tế; và ngược lại, giúp bạn bè quốc tế gửi gắm những thông điệp kết nối. Vì thế, tớ sẽ chủ động liên hệ với các hội nhóm Ethereum toàn quốc và ở nước ngoài để triển khai việc quay video.</p>
